...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            'App\\AdminBundle\\Controller\\LoginController' => __DIR__.'/getLoginControllerService.php',
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'HomeBundle' => array(
                    'path' => ($this->targetDirs[3].'/src/HomeBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HomeBundle' => 'App\\HomeBundle\\HomeBundle',
