...
require_once $this->targetDirs[3].'/vendor/symfony/http-kernel/Fragment/FragmentHandler.php';
require_once $this->targetDirs[3].'/vendor/symfony/http-kernel/DependencyInjection/LazyLoadingFragmentHandler.php';
