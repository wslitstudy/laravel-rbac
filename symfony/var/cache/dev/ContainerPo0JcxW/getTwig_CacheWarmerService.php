...
require_once $this->targetDirs[3].'/vendor/symfony/twig-bundle/CacheWarmer/TemplateCacheCacheWarmer.php';
...
})), ($this->privates['templating.finder'] ?? $this->load(__DIR__.'/getTemplating_FinderService.php')), array(($this->targetDirs[3].'/templates') => NULL));
