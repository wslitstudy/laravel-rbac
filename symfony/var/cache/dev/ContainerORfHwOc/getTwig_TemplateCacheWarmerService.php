...
require_once $this->targetDirs[3].'/vendor/symfony/twig-bundle/TemplateIterator.php';
require_once $this->targetDirs[3].'/vendor/symfony/http-kernel/CacheWarmer/CacheWarmerInterface.php';
require_once $this->targetDirs[3].'/vendor/symfony/twig-bundle/CacheWarmer/TemplateCacheWarmer.php';
...
})), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel')), ($this->targetDirs[3].'/src'), array(($this->targetDirs[3].'/templates') => NULL)));
